            ...
            <div class="card-body p-4">
                ...
                <form method="post" action="index.php?page=produk&action=update">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="nama_produk" value="<?= e($data['nama_produk']); ?>" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="number" name="harga" value="<?= e($data['harga']); ?>" required>
                    </div>
                    <div class="mb-3">
